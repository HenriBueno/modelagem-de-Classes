...
class BombaCombustivel {
  ...
  abastecerPorValor(valor: number) {
    ...
    if (this.quantidadeCombustivel > novoValor) {
      ...
      console.log(
        `Não há gasolina o suficiente para abastecer esta quantia, pois há somente: ${this.quantidadeCombustivel} Litros`
      );
    }
  }
  ...
  alterarQuantidadeCombustivel(novoValorCombustivel: number){
